...
def app():
    ...
    with cola:
        ...
        url_ayang = "https://raw.githubusercontent.com/Imaj1n/MyWeb/5f99c6544c11eadf4273060158e09584376bdf41/src2/Bahan_Lain/Gif_Us/Gif_Ayang1.gif"
        #Gif_Ayang1.gif
...
if __name__ == "__main__":
    ...
    # # Menampilkan GIF di sidebar berdasarkan waktu
    # gif_for_conditions = {
    #     "morning": "https://i.pinimg.com/originals/b0/9a/06/b09a0682c2cd4d291bf195d52870affd.gif",
    #     "afternoon": "https://i.pinimg.com/originals/b0/9a/06/b09a0682c2cd4d291bf195d52870affd.gif",
    #     "evening": "https://i.pinimg.com/originals/b0/9a/06/b09a0682c2cd4d291bf195d52870affd.gif",
    # }
    ...
    # # Pilih GIF berdasarkan kondisi waktu
    # selected_gif_url = gif_for_conditions[condition]
    # st.sidebar.image(selected_gif_url, use_container_width=True)

    # Daftar GIF untuk kondisi waktu
